								...
								<ul class="nav main_nav navbar-nav">
									...
									<li class="dropdown delivery">
										...
										<ul class="dropdown-menu">
											<li id="drop_main"><a href="#">Доставка</a></li>
											<li class="divider"></li>
							...
							<tbody>
								...
								<tr>
									<td>
										...
										<ul>
											<li id="iml"><a href="http://iml.ru/places?Moscow"><img style="width: 22px;" src="image/IML.png" alt=""></a>&nbspIML</li>
											<li id="boxberry"><a href="http://boxberry.ru/find_an_office/"><img style="width: 22px;" src="image/Boxberry.png" alt=""></a>&nbspBoxberry</li>
										</ul>
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td>
										...
										<ul>
											<li id="iml"><a href="http://iml.ru/places?Moscow"><img style="width: 22px;" src="image/IML.png" alt=""></a>&nbspIML</li>
											<li id="boxberry"><a href="http://boxberry.ru/find_an_office/"><img style="width: 22px;" src="image/Boxberry.png" alt=""></a>&nbspBoxberry</li>
											<li id="pr"><a href="https://www.pochta.ru/"><img style="width: 22px;" src="image/ПочтаРоссии.png" alt=""></a>&nbspПочта России</li>
											<li id="b-s"><a href="https://www.baikalsr.ru/"><img style="width: 22px;" src="image/БайкалСервис.png" alt=""></a>&nbspБайкал-сервис</li>
											<li id="sdek"><a href="http://www.edostavka.ru/"><img style="width: 22px;" src="image/СДЭК.png" alt=""></a>&nbspСДЭК</li>
											<li id="dl"><a href="http://www.dellin.ru/"><img style="width: 22px;" src="image/ДеловыеЛинии.png" alt=""></a>&nbspДеловые линии</li>
											<li id="pek"><a href="http://pecom.ru/"><img style="width: 22px;" src="image/ПЭК.png" alt=""></a>&nbspПЭК</li>
										</ul>
									</td>
