		...
		<div class="col-md-12 content">
			...
			<div class="col-md-6">
				...
				<div class="col-md-12 cont">
					<div class="container-fluid prod_container">
						
						<div class="col-md-12">
							<div class="container-fluid">
								<div class="col-md-6 img_prod">
									<img src="600 Логотип/KR1035A422.jpg" alt="">
								</div>
								<div class="col-md-6 prod_info">
									
									<h3 id="name_prod">Клапан системы вентиляции картера</h3>

									<p>Производитель: Kemptner</p>
									<p>Артикул: KR1035A422</p>
									<p>Есть в наличии</p>

									<h3>1000 руб.</h3>

									<span>Количество: </span><input min="1" name="quantity" type="number" value="1">

									<button type="button"><img src="image/cart.png" alt=""><span>В корзину</span></button>

								</div>
							</div>
						</div>

						<div class="col-md-12 all_comments_cont">

							<button type="button" id="add_comment">Оставить отзыв</button>
							
							<h3>Отзывы (2)</h3>

							<div class="container-fluid">

								<div class="col-md-12 comments_cont">
									<div class="container-fluid">
										<div class="col-md-2 meta_comment" align="center">
											
											<span id="login">Гость</span>
										...
										<div class="col-md-10 comment">
											<div class="container-fluid">
												<div class="col-md-12 comment_text">
													<span id="comment">Lorem ipsum dolor sit amet.</span>
												</div>
												<div class="col-md-12" id="time">
													<span>11.02.2018 15:50</span>
												</div>
											</div>
										</div>
									</div>
									...
									<div class="container-fluid">
										...
										<div class="col-md-10 comment">
											<div class="container-fluid">
												...
												<div class="col-md-12 comment_text">
													<span id="comment">
												Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatum modi saepe eaque tempora fugit maxime accusamus natus ex? Ab suscipit accusamus veritatis a, et, ut doloribus omnis quo quos, recusandae sunt. Ab ullam, excepturi vitae. Est saepe iure velit reprehenderit vel, aut in. Beatae qui ad deserunt quia ullam sit.
													</span>
												</div>
												<div class="col-md-12" id="time">
													<span>11.02.2018 15:50</span>
